...
//		
//		if(target == null){
//			Log.d(TAG, "2. target is null!");
//		}else{
//			Log.d(TAG, "2. target is not null!");
//		}
...
//		if(target == null){
//			Log.d(TAG, "3. target is null!");
//		}else{
//			Log.d(TAG, "3. target is not null!");
//		}
	...
	private void applyTo(View target) {
		...
		if (target instanceof TabWidget) {
			...
			try{
				...
				if(group == null)Log.d(TAG, "group is null");
