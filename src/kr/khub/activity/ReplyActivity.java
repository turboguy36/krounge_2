	...
	void makeMainView(){
		...
		if(attached_img_url != null && !attached_img_url.equals("")) {
			...
			if(attached_img_url.contains(".flv")){
				...
				kr.khub.listener.AppClickListener acListener = new kr.khub.listener.AppClickListener(snsinfo, this);//new AppClickListener(added_imageurl, replyCount, htmlmessage);
