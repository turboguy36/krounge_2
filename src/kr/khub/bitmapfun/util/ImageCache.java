...
public class ImageCache {
	...
	public BitmapDrawable getBitmapFromMemCache(String data) {
		...
		if (AppConfig.DEBUG && memValue != null) {
	...
	/**
	 * Get a usable files directory (external if available, internal otherwise).
	 *
	 * @param context The context to use
	...
	public static File getFilesDir(Context context) {
		// Check if media is mounted or storage is built-in, if so, try and use external files dir
				...
				final String filesPath =
						Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) ||
						!isExternalStorageRemovable() ? getExternalFilesDir(context).getPath() :
							context.getFilesDir().getPath();
...
*/
	...
	public static File getExternalFilesDir(Context context) {
		...
		// Before Froyo we need to construct the external cache dir ourselves
		final String filesDir = "/Android/data/" + context.getPackageName() + "/file/";
