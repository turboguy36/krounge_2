...
import kr.co.ktech.cse.bitmapfun.util.ImageCache;
...
public class FileDownloadManager extends Activity implements OnClickListener{
...
//	private String notiMessage;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.file_download_manager);
		...
		title_image = (ImageView)findViewById(R.id.icon_image);
	...
	public void startDownload(View v) {
		...
		title_image.setImageResource(R.drawable.icon_klounge);
...
//				.append(notiMessage);
	...
	private String getUrl(){
		String jspFilename = isUrlLink? "appDataDownDataInfo.jsp" : "appFileDownFromFileLibrary.jsp";
